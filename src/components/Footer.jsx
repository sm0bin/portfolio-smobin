...
const Footer = () => {
    ...
    return (
        <footer className="bg-base-200">
            ...
            <div className="max-w-7xl mx-4 md:mx-8 lg:mx-auto footer py-10  text-base-content">
                <aside>
                    ...
                    <nav className="flex gap-4 mt-6 text-2xl">
                        {
                            socialLinks.map((link, index) => (
                                <Link key={index} className="hover:text-secondary duration-300" to={link.link} target="_blank">{link.icon}</Link>
                            ))
                        }
                    </nav>
                </aside>
