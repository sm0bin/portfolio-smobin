    ...
    return (
        <footer>
            ...
            <div className="footer items-center p-4 bg-neutral ">
                ...
                <nav className="grid-flow-col gap-3 md:place-self-center md:justify-self-end text-2xl">
                    <Link className="p-2 rounded-lg bg-secondary text-base-100 hover:scale-90 duration-300" to='https://github.com/sm0bin' target="_blank"><FaGithub /></Link>
                    <Link className="p-2 rounded-lg bg-secondary text-base-100 hover:scale-90 duration-300" to='https://www.linkedin.com/in/m0bin/' target="_blank"><FaLinkedin /></Link>
                    <Link className="p-2 rounded-lg bg-secondary text-base-100 hover:scale-90 duration-300" to='https://www.facebook.com/m00bin/' target="_blank"><FaFacebook /></Link>
                    <Link className="p-2 rounded-lg bg-secondary text-base-100 hover:scale-90 duration-300" to='https://www.behance.net/smobin' target="_blank"><FaBehance /></Link>
                    <Link className="p-2 rounded-lg bg-secondary text-base-100 hover:scale-90 duration-300" to='https://dribbble.com/smobin' target="_blank"><FaDribbble /></Link>
                </nav>
            </div>
        </footer>
    );
